These files are versions of the loose .lua files found in Demon's Souls "script" directory, but with added English translations appended as comments to each line containing Japanese text.
